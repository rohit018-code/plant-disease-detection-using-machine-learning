...
MODEL = tf.keras.models.load_model(r"C:\Users\Rohit\Desktop\finalproject\API\API\models\model.hdf5")
leaf_model = tf.keras.models.load_model(r"C:\Users\Rohit\Desktop\finalproject\API\API\models\is_leaf_model.hdf5")
...
def predict_page():
    if request.method == "POST":
        ...
        file.save("C:/Users/Rohit/Desktop/finalproject/API/API/static/img_uploades/"+file.filename)
        file_location = f"C:/Users/Rohit/Desktop/finalproject/API/API/static/img_uploades/{file.filename}"
